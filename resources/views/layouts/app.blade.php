...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-secondary { background: transparent; color: #fff; padding: 10px 28px; border-radius: 50px; text-decoration: none; font-weight: 600; border: 2px solid rgba(255,255,255,0.1); transition: all 0.3s ease; display: inline-block; font-size: 14px; }
        .btn-secondary:hover { background: rgba(255,255,255,0.05); border-color: #ff6b6b; transform: translateY(-3px) scale(1.03); box-shadow: 0 10px 30px rgba(255,107,107,0.1); color: #ff6b6b; }

        .btn-white { background: #fff; color: #0a0e1a !important; padding: 10px 28px; border-radius: 50px; text-decoration: none; font-weight: 600; transition: all 0.3s ease; display: inline-block; font-size: 14px; }
        .btn-white:hover { background: #ffd93d; color: #0a0e1a !important; transform: translateY(-3px) scale(1.03); box-shadow: 0 10px 40px rgba(255,217,61,0.3); }
        ...
        .hero .particles { position: absolute; width: 100%; height: 100%; top: 0; left: 0; pointer-events: none; overflow: hidden; }
        .hero .particles .particle { position: absolute; border-radius: 50%; animation: particleFloat 15s ease-in-out infinite; }
        .hero .particles .particle:nth-child(1) { width: 6px; height: 6px; background: #ff6b6b; top: 20%; left: 10%; animation-delay: 0s; box-shadow: 0 0 20px #ff6b6b; }
        .hero .particles .particle:nth-child(2) { width: 8px; height: 8px; background: #ffd93d; top: 60%; right: 5%; animation-delay: -2s; box-shadow: 0 0 25px #ffd93d; }
        .hero .particles .particle:nth-child(3) { width: 5px; height: 5px; background: #6bcb77; top: 30%; right: 25%; animation-delay: -4s; box-shadow: 0 0 15px #6bcb77; }
        .hero .particles .particle:nth-child(4) { width: 10px; height: 10px; background: #4d96ff; bottom: 20%; left: 20%; animation-delay: -6s; box-shadow: 0 0 30px #4d96ff; }
        .hero .particles .particle:nth-child(5) { width: 7px; height: 7px; background: #ff6b6b; top: 70%; left: 40%; animation-delay: -3s; box-shadow: 0 0 20px #ff6b6b; }
        @keyframes particleFloat { 0%,100% { transform: translate(0,0) scale(1); } 25% { transform: translate(60px,-80px) scale(1.5); } 50% { transform: translate(-40px,60px) scale(0.7); } 75% { transform: translate(80px,40px) scale(1.3); } }

        .hero .floating-shapes .shape { position: absolute; border-radius: 50%; opacity: 0.03; animation: shapeFloat 25s ease-in-out infinite; }
        .hero .floating-shapes .shape:nth-child(1) { width: 150px; height: 150px; background: #ff6b6b; top: 5%; left: 3%; animation-delay: 0s; }
        .hero .floating-shapes .shape:nth-child(2) { width: 100px; height: 100px; background: #ffd93d; top: 75%; right: 5%; animation-delay: -5s; }
        .hero .floating-shapes .shape:nth-child(3) { width: 80px; height: 80px; background: #6bcb77; top: 45%; right: 18%; animation-delay: -10s; }
        .hero .floating-shapes .shape:nth-child(4) { width: 120px; height: 120px; background: #4d96ff; bottom: 15%; left: 25%; animation-delay: -15s; }
        .hero .floating-shapes .shape:nth-child(5) { width: 60px; height: 60px; background: #ff6b6b; top: 30%; left: 50%; animation-delay: -7s; }
        @keyframes shapeFloat { 0%,100% { transform: translate(0,0) rotate(0deg) scale(1); } 25% { transform: translate(80px,-60px) rotate(90deg) scale(1.2); } 50% { transform: translate(-50px,70px) rotate(180deg) scale(0.8); } 75% { transform: translate(100px,50px) rotate(270deg) scale(1.1); } }
        ...
        #cta .cta-content h2 span { color: #fff !important; }
        #cta .cta-content p { color: rgba(255,255,255,0.85) !important; }
        ...
        @media (max-width: 992px) {
            ...
            .mega-menu-content { min-width: 160px; left: 0; transform: translateX(0); }
            .nav-item:hover .mega-menu-content { transform: translateX(0); }
